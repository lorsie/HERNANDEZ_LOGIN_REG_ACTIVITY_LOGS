...
if (isset($_POST['insertApplicantBtn'])) {
    ...
    $insertApplicant = insertNewApplicant($pdo, $_POST['first_name'], $_POST['last_name'], $_POST['position'], $_POST['gender'], $_POST['age'], $_POST['email'], $_POST['contact_number'], $_POST['address'], $_POST['hire_date'], $addedBy);
...
if (isset($_POST['editApplicantBtn'])) {
    ...
    $editApplicant = editApplicant($pdo, $_POST['first_name'], $_POST['last_name'], $_POST['position'], $_POST['gender'], $_POST['age'], $_POST['email'], $_POST['contact_number'], $_POST['address'], $_POST['hire_date'], $_GET['id'], $modifiedBy);
